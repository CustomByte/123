local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/CustomByte/123/refs/heads/main/idk.lua"))()


library.rank = "private"
local Wm = library:Watermark("Fatal.lua" ..  " | " .. library:GetUsername() .. " | rank: " .. library.rank)
local Notif = library:InitNotifications()

for i = 4,0,-1 do 
    task.wait(0.5)
    local LoadingXSX = Notif:Notify("loading fatal.lua", 3, "information") -- notification, alert, error, success, information
end 

library.title = "fatal.lua"
...
local Tab2 = Init:NewTab("Agility")
local Tab3 = Init:NewTab("HvH")
local Tab4 = Init:NewTab("Mics")
local Tab5 = Init:NewTab("Settings")

local Section1 = Tab1:NewSection("Aimbot")
local Section2 = Tab1:NewSection("Blatant / Silent")
local Section3 = Tab1:NewSection("Config")
